...
public static class RectanglesTask
{
    ...
    public static bool IsRectangleSecondInRectangleFirst(Rectangle r1, Rectangle r2)
    {
    ...
    public static int IntersectionSquare(Rectangle r1, Rectangle r2)
    {
        ...
        {
            var leftIntersection = Math.Max(r1.Left, r2.Left);
            var rightIntersection = Math.Min(r1.Right, r2.Right);
            var topIntersection = Math.Max(r1.Top, r2.Top);
            var bottomIntersection = Math.Min(r1.Bottom, r2.Bottom);
    ...
    {
        if (IsRectangleSecondInRectangleFirst(r1, r2))
            return 1;
        else if (IsRectangleSecondInRectangleFirst(r2, r1))
            return 0;
        else
            return -1;
    }
